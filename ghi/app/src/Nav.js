      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" to="sales/create">New Sale</NavLink>
            </li>
            {/* Manufacturers */}
            <li className="nav-item">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" to="salespeople/create">New Salesperson</NavLink>
            </li>
            {/* Customers */}
            <li className="nav-item">
            ...
            <li className="nav-item">
              <NavLink className="nav-link" to="customers/create">New Customer</NavLink>
            </li>
            {/* Models */}
            <li className="nav-item">
